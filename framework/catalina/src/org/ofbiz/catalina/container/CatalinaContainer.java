...
public class CatalinaContainer implements Container {
    ...
    public boolean start() throws ContainerException {
        ...
        for (Connector con: tomcat.getService().findConnectors()) {
            ...
            System.out.println("Connector " + con.getProtocol() + " @ " + con.getPort() + " - " + (con.getSecure() ? "secure" : "not-secure") + " [" + con.getProtocolHandlerClassName() + "] started.");
        }
        Debug.logInfo("Started " + ServerInfo.getServerInfo(), module);
        System.out.println("App Started. " + ServerInfo.getServerInfo());
        return true;
    }
