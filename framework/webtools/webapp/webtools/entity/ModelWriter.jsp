...
<%
  ...
  if (originalLoaderName != null && originalLocation != null && EntityConfig.ENTITY_ENGINE_XML_FILENAME != null  && "entityengine.xml".equals(EntityConfig.ENTITY_ENGINE_XML_FILENAME) ) {
...
<entitymodel>
  ...
  <!--  - <%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(pName)%> --><%
  }%>
  <!-- ========================================================= -->
<%
...
%>
    <view-entity entity-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getEntityName())%>"
            package-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getPackageName())%>"<%if (entity.getDependentOn().length() > 0) {%>
            dependent-on="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getDependentOn())%>"<%}%><%if (entity.getNeverCache()) {%>
...
%>
    <entity entity-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getEntityName())%>"<%if (!entity.getEntityName().equals(ModelUtil.dbNameToClassName(entity.getPlainTableName()))){
          %> table-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getPlainTableName())%>"<%}%>
            package-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getPackageName())%>"<%if (entity.getDependentOn().length() > 0) {%>
            dependent-on="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getDependentOn())%>"<%}%><%if (entity.getDoLock()) {%>
