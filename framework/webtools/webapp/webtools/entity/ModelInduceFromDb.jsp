...
%>
    <entity entity-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getEntityName())%>"<%if(!entity.getEntityName().equals(ModelUtil.dbNameToClassName(entity.getPlainTableName())) || !ModelUtil.javaNameToDbName(entity.getEntityName()).equals(entity.getPlainTableName()) ){
          %> table-name="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getPlainTableName())%>"<%}%>
            ...
            dependent-on="<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(entity.getDependentOn())%>"<%}%><%if(!title.equals(entity.getTitle())){%>
