...
public class ContextFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
    	//System.out.println("ContextFilter...... init>>"+config);
        this.config = config;
        ...
        /*
        System.out.println("ContextFilter...... Start.getInstance().getCurrentState()>>"+Start.getInstance().getCurrentState());
        if (!Start.getInstance().getCurrentState().equals(ServerState.STARTING)) {
        	try {
        		System.out.println("ContextFilter...... starting server");
				Start.main(new String[0]);
				System.out.println("ContextFilter...... starting server done");
			} catch (StartupException e) {
				e.printStackTrace();
				System.out.println("Error to start instance in ContextFilter....... ");
			}
        }*/
        ...
        if (httpRequest.getAttribute(ContextFilter.FORWARDED_FROM_SERVLET) == null) {
            ...
            if (allowList != null &&
                ...
                if (redirectPath == null) {
                    ...
                    String safeContextUri = StringEscapeUtils.escapeHtml(contextUri);
                    filterMessage = filterMessage + " (" + error + ")";
                    httpResponse.sendError(error, safeContextUri);
                    request.setAttribute("filterRequestUriError", safeContextUri);
                } else {
    ...
    protected String getServerId() {
        ...
        if (serverId == null) {
            ...
            if (UtilValidate.isEmpty(serverId)) {
