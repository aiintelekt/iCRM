...
public class EmailServices {
    ...
    public static Map<String, Object> sendMail(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            session.getProperties().put("mail.smtp.ssl.trust", EntityUtilProperties.getPropertyValue("general", "mail.smtp.relay.host", delegator));
            ...
            if (UtilValidate.isNotEmpty(senderName)) {
            	 mail.setFrom(new InternetAddress(sendFrom,senderName));
            }else {
