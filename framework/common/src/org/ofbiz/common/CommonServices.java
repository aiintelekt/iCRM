...
public class CommonServices {
    ...
    public static Map<String, Object> createNote(DispatchContext ctx, Map<String, ?> context) {
        ...
        Timestamp expiredDate = (Timestamp) context.get("expiredDate");
        ...
        Map<String, Object> fields = UtilMisc.toMap("noteId", noteId, "noteName", noteName, "noteInfo", note,
                "noteParty", partyId, "noteDateTime", noteDate, "createdByUserLogin", userLogin.getString("userLoginId"),"expiredDate",expiredDate);
