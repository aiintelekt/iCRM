...
public class UelUtil {
    ...
    public static Object evaluate(Map<String, ? extends Object> context, String expression, Class<?> expectedType) {
        ...
        // Validate expression against a whitelist of safe expressions or patterns
        if (!isValidExpression(expression)) {
            throw new SecurityException("Invalid or unsafe expression");
        }
        
        // Create a secure EL context
        ELContext elContext = new ReadOnlyContext(context);
    ...
    private static boolean isValidExpression(String expression) {
        ...
        // Example: Ensure the expression matches a safe pattern or contains only allowed characters
