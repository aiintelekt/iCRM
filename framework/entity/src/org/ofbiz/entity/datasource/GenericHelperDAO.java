...
public class GenericHelperDAO implements GenericHelper {
	...
	public long findCountByCondition(Delegator delegator, ModelEntity modelEntity, EntityCondition whereEntityCondition,
			...
			throws GenericEntityException {
    	return findCountByCondition(delegator, modelEntity, whereEntityCondition, havingEntityCondition, selectFields, findOptions, null);
	}
    ...
    public long findCountByCondition(Delegator delegator, ModelEntity modelEntity, EntityCondition whereEntityCondition,
			...
			throws GenericEntityException {
    	return genericDAO.selectCountByCondition(delegator, modelEntity, whereEntityCondition, havingEntityCondition, selectFields, findOptions, context);
	}
