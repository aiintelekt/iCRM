...
context.put("oldContextMap", org.fio.homeapps.util.ParamUtil.mapToJson(inputContext));
...
if (UtilValidate.isNotEmpty(userAuditRequestId)) {
	...
	auditTrackList = org.fio.homeapps.util.UtilUserAudit.prepareInputAuditTrack(auditRequest);
