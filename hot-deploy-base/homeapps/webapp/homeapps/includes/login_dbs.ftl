...
$(document).ready(function() {
  ...
  <body>
          ...
          <div class="col-md-6 padding-l ">
            <section class="login-form">
              ...
              <form method="post" action="<@ofbizUrl>main</@ofbizUrl>" role="login" class="form-horizontal">
                <img src="/bootstrap-dbs/images/dbs-logo.png" class="img-responsive" alt=""/>
               ...
               <input id="login-password" type="password" class="form-control" name="PASSWORD" placeholder="Password">
                ...
                <input type="submit" name="go" class="btn btn-md btn-primary btn-block font-weight-bold" value="Sign in">
                <div class="clearfix">
    ...
    <div class="text-center footer-img">
      <img style="display: inline-block;" class="img-fluid" src="/bootstrap-dbs/images/footer-bg.png" alt="">
    </div>
