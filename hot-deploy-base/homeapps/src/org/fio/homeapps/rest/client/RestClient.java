 ...
 */
public class RestClient extends ApiClient implements javax.net.ssl.X509TrustManager {
	...
	public RestClient(Delegator delegator, ConfigurationParam configurationParam, GenericValue channelAccess,
			String accessType) {
