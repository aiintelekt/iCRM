  ...
  <ul>
    <li>
      <ul>
        ...
        <li class="selected"><a href="/fio-dataimport/control/invoiceImp">INVOICE</a>
</li>
      </ul>
    </li>
  </ul>
...
<div class="screenlet-title-bar"><ul><li class="h3">Data Import Invoice</li>
<li class="expanded">
...
<table>
  ...
  <tbody>
  <tr>
    <form name="scheduleInvoiceData" method="post" action="<@ofbizUrl>scheduleInvoiceData</@ofbizUrl>">
    
	  <input type="hidden" name="SERVICE_NAME" value="importinvoice">
	  <input type="hidden" name="importedType" value="invoice">
	  <input type="hidden" name="POOL_NAME" value="pool">
	  <input type="hidden" name="sectionHeaderUiLabel" value="DataImportImportCustomers">
	  <td class="" style=""><span class="tabletext" style="">Invoice Header Lines:</span></td>
	  <td class="" style=""><span class="tabletext" style=""></span>${InvoiceHeaderProcessed?if_exists}</td>
	  <td class="" style=""><span class="tabletext" style=""></span>${InvoiceHeaderNotProcessed?if_exists}</td>
	  <td class="">  <input type="submit" value="Schedule" class="smallSubmit" onclick="submitFormWithSingleClick(this)">
	</td>
	  <td class="" style="">
	  <tr>
	  <td class="" style=""><span class="tabletext" style="">Invoice Item Lines:</span></td>
	  <td class="" style=""><span class="tabletext" style="">${InvoiceItemProcessed?if_exists}</span></td>
	  <td class="" style=""><span class="tabletext" style="">${InvoiceItemNotProcessed?if_exists}</span></td>
	</td>  </tr>
	</td>  
	</form>  
  </tr>
...
<table style="width:100%">
	<thead>
		...
		<#if list.tableName == "DataImportInvoice" || list.tableName == "DataImportInvoiceItem">
			<tr>
			<td>
