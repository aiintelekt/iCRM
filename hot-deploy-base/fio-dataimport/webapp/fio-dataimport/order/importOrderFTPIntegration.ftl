...
<div class="button-bar tab-bar">
  <ul>
    <li>
      <ul>
        <li><a href="/fio-dataimport/control/main"> CUSTOMER</a>
</li>
        <li ><a href="/fio-dataimport/control/supplierImp">SUPPLIER</a>
</li>
        <li  class="selected"><a href="/fio-dataimport/control/orderImp">ORDER</a>
</li>
...
<div class="screenlet-title-bar"><ul><li class="h3">Data Import Order</li>
<li class="expanded">
...
<table>
  ...
  <tbody>
  <tr>
    <form name="scheduleOrderData" method="post" action="<@ofbizUrl>scheduleOrderData</@ofbizUrl>">
	  <input type="hidden" name="SERVICE_NAME" value="importOrder">
	  <input type="hidden" name="importedType" value="ORDER">
	  <input type="hidden" name="POOL_NAME" value="pool">
	  <input type="hidden" name="importStatusId" value="">
	  <input type="hidden" name="sectionHeaderUiLabel" value="DataImportImportCustomers">
	  <td class="" style=""><span class="tabletext" style="">Order Header Lines:</span></td>
	  <td class="" style=""><span class="tabletext" style="">${orderHeadersProcessed?if_exists}</span></td>
	  <td class="" style=""><span class="tabletext" style="">${orderHeadersNotProcessed?if_exists}</span></td>
	  <td class="">  <input type="submit" value="Schedule" class="smallSubmit" onclick="submitFormWithSingleClick(this)">
	</td>
	  <td class="" style="">
	  <tr>
	  <td class="" style=""><span class="tabletext" style="">Order Item Lines:</span></td>
	  <td class="" style=""><span class="tabletext" style="">${orderItemsProcessed?if_exists}</span></td>
	  <td class="" style=""><span class="tabletext" style="">${orderItemsNotProcessed?if_exists}</span></td>
	</td>  </tr>
	</form>  
  </tr>
</tbody></table>
...
<table style="width:100%">
	<thead>
	 ...
	 <tbody>
		...
		<#if list.tableName == "DataImportOrderHeader" || list.tableName == "DataImportOrderItem">
		<tr>
			<td>
