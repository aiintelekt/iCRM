  ...
  <ul>
    <li>
      <ul>
        ...
        <li class="selected"><a href="/fio-dataimport/control/supplierImp">SUPPLIER</a>
</li>
...
<div class="screenlet-title-bar"><ul><li class="h3">Data Import Supplier</li>
<li class="expanded">
...
<table>
  ...
  <tbody>
  <tr>
    <form name="scheduleSupplierData" method="post" action="<@ofbizUrl>scheduleSupplierData</@ofbizUrl>">
    
	  <input type="hidden" name="SERVICE_NAME" value="importSuppliers">
	  <input type="hidden" name="importedType" value="SUPPLIER">
	  <input type="hidden" name="POOL_NAME" value="pool">
	  <input type="hidden" name="sectionHeaderUiLabel" value="DataImportImportCustomers">
	  <td class="" style=""><span class="tabletext" style="">Suppliers:</span></td>
	  <td class="" style=""><span class="tabletext" style="">${suppliersProcessed?if_exists}</span></td>
	  <td class="" style=""><span class="tabletext" style="">${suppliersNotProcessed?if_exists}</span></td>
...
<table style="width:100%">
	<thead>
		...
		<#if list.tableName=="DataImportSupplier">
			<tr>
			<td>
