...
activeTab = parameters.get("activeTab");
if(UtilValidate.isNotEmpty(activeTab)){
...
context.put("statusIdList", DataHelper.getDropDownOptions(buStatusDetails, "enumId", "description"));
...
context.put("buTypeIdList", DataHelper.getDropDownOptions(buTypeDetails, "productStoreGroupTypeId", "description"));
...
if (UtilValidate.isNotEmpty(viewBusinessUnit))
{
	...
	inputContext.put("buName",viewBusinessUnit.getString("productStoreGroupName"));
	...
	context.put("buType",viewBusinessUnit.getString("productStoreGroupTypeId"));
	context.put("buStatus",viewBusinessUnit.getString("status"));
	
	inputContext.put("buType",viewBusinessUnit.getString("productStoreGroupTypeId"));
	inputContext.put("status",viewBusinessUnit.getString("status"));
	...
	if (UtilValidate.isNotEmpty(primaryParentGroupId)){
		context.put("parentBuId",viewBusinessUnit.getString("primaryParentGroupId"));
		inputContext.put("parentBuId",viewBusinessUnit.getString("primaryParentGroupId"));
