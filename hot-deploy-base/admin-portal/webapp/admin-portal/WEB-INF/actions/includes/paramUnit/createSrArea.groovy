...
List<GenericValue> srArea = delegator.findByAnd("CustRequestAssoc", UtilMisc.toMap("type", AdminPortalConstant.ParamUnitConstant.SR_TYPE,"active","Y"), null, false);
context.put("srTypeIds", DataHelper.getDropDownOptions(srArea, "code", "value"));
