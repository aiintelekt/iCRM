<#include "component://bootstrap/lib/ofbizFormMacros.ftl"/>
      ...
      <div class="row">
        <div id="main" role="main">
          <@sectionFrameHeader title="${uiLabelMap.FindActivitySubTypes!}" />
...
<div id="accordion">
              <div class="row">
                <div class="iconek">
                  ...
                  <div class="border rounded bg-light margin-adj-accordian pad-top">
                    <form action="activeActivitySubTypes" method="post" id="searchForm" name="searchForm">
                      <@inputHidden 
                        id="searchCriteria"
                      />
                      <div class="row p-2">
                        ...
                        <#assign activitySubTypes = delegator.findByAnd("WorkEffortAssocTriplet", {"type" : "SubType"}, null, false)>
                           ...
                           <@dropdownCell 
                              ...
                              placeholder=uiLabelMap.SelectActivitySubType
                              options=activitySubTypeList!
                              value="${requestParameters.activitySubType?if_exists}"
                              allowEmpty=true
                              />
                          
                          <div class="text-right">
                               <@button label="${uiLabelMap.Search}"
                                id="main-search-btn"
                                /></div>
            ...
            <#assign rightContent='<a title="Create" href="/admin-portal/control/activitySubTypes" class="btn btn-primary btn-xs ml-2" target="_blank"> <i class="fa fa-plus" aria-hidden="true"></i> Create </a>' />   
						 		
			<@AgGrid
			gridheadertitle=uiLabelMap.ListOfActivitySubTypes
			gridheaderid="activity-activitySubType-grid-action-container"
			savePrefBtn=true
			clearFilterBtn=true
			exportBtn=true
			insertBtn=false
		    ...
		    <script type="text/javascript" src="/admin-portal-resource/js/ag-grid/param-unit/activity-subType.js"></script>				
