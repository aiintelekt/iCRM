...
<#include "component://homeapps/webapp/homeapps/user-audit/audit_page_header.ftl"/>
      ...
      <div class="row">
        <div id="main" role="main">
         ...
         <@sectionFrameHeader title="${uiLabelMap.CreateActivitySubType!}" extra=extra />
         
<form id="mainFrom" action ="<@ofbizUrl>createActivitySubType</@ofbizUrl>" method="post">
...
<#include "component://homeapps/webapp/homeapps/user-audit/audit_from_header.ftl"/>
  ...
  function formSubmission(){
    ...
    var seqerr="";
    if(activityType!=''&& status!=''&& activitySubType!=''&& activityParent!='' ){
         if(sequenceNumber != "")
       {
