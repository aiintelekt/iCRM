...
<#include "component://homeapps/webapp/homeapps/user-audit/audit_page_header.ftl"/>
      ...
      <div class="row">
        <div id="main" role="main">
         ...
         <@sectionFrameHeader title="${uiLabelMap.UpdateResponseReason!}" extra=extra />
<form id="mainFrom" action ="<@ofbizUrl>oppResponseReasonUpdation</@ofbizUrl>" method="post">
          ...
          <div class="form-group offset-2">
            <div class="text-left ml-3">
              <input type="submit" class="btn btn-sm btn-primary" onclick="return formSubmission();" value="Update">
                             <a href="oppResponseReason"class="btn btn-sm btn-secondary"> Cancel</a>
            </div>
          </div>
		  </form>
        </div>
