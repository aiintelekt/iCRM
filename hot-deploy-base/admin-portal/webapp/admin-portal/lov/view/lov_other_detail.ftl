...
<div class="page-header border-b pt-2">
  <h2 class="d-inline-block">General Details</h2>
   <ul class="flot-icone">
    ...
    <a href="<@ofbizUrl>updateOtherLov?lovId=</@ofbizUrl>${inputContext.lovId!}&lovTypeId=${inputContext.lovTypeId!}" class="btn btn-xs btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> Update</a>
  </ul>
</div>
