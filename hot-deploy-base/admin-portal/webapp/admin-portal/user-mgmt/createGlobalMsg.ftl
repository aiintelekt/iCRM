 <#include "component://admin-portal/webapp/admin-portal/global/ofbizFormMacros.ftl"/> 
  <div class="row">
		...
		<form id="mainFrom" action ="<@ofbizUrl>globalMessageCreation</@ofbizUrl>" method="post">
		         <div class="col-lg-12 col-md-12 col-sm-12"><@sectionFrameHeader title="${uiLabelMap.ScrollingMessageCreation!}"  /></div>
		...
		<#include "component://homeapps/webapp/homeapps/user-audit/audit_from_header.ftl"/>
					 <div class="col-md-10 col-lg-6 col-sm-10">
                         ...
                         <@dropdownCell
					         id="componentId"
					         label=uiLabelMap.componentName
