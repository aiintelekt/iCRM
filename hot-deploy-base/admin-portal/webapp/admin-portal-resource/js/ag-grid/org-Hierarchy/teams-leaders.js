...
var columnDefs = [
	 {  
         ...
         "filter":"agTextColumnFilter",
            cellRenderer:params => `<a href="#" onclick="add_value('addLeadersForm','${params.data.partyId}','newPartyIdLeader');">${params.value}</a>`,
      }, 
      {  
         "headerName":"NewpartyId ",
         "field":"partyId",
         "hide":true
      },
      {  
...
function loadAgGrid(){
	...
	var gridOptions = {
		...
		var eGridDiv = document.querySelector("#T006");
