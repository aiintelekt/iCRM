...
var columnDefs = [
	{
		...
		cellRenderer: params =>
	      `<a href="#" onclick="testFunction('${params.value}','${params.data.productStoreGroupId}');" id="parentBuisnessId">${params.value}</a>`
	  }, {
...
function getGridData() {
    ...
    $.ajax({
        type: "POST",
        url: "getParentBusinessUnitInUpdate",
        async: false,
        data:  { "productStoreGroupId": $("#productStoreGroupId").val() },
