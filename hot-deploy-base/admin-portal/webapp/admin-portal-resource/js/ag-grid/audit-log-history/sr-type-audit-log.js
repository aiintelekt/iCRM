...
function onBtExport() {
    var params = {
        skipHeader: false,
        allColumns: true,
        fileName: "Service_Request_Type_History",
        exportMode: 'csv'
    };
...
fagReady("SR_TYPE_AUDIT_LOG", function(el, api, colApi, gridApi){
    $("#sr-type-audit-ref-pref").click(function () {
    	gridApi.refreshUserPreferences();
    });
    $("#sr-type-audit-save-pref").click(function () {
    	gridApi.saveUserPreferences();
    });
    $("#sr-type-audit-clear-filter").click(function () {
    ...
    $("#sr-type-audit-export").click(function () {
    	gridApi.csvExport();
    });
    loadSrTypeAuditLog(gridApi, api);
});

var srTypeAuditLogUrl = "";
function loadSrTypeAuditLog(gridApi, api) {
	if(srTypeAuditLogUrl == ""){
		srTypeAuditLogUrl = getGridDataFetchUrl("SR_TYPE_AUDIT_LOG");
	}
	var rowData =[];
