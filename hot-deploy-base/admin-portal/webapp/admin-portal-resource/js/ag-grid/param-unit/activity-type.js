...
fagReady("PARAM_ACT_TYP", function(el, api, colApi, gridApi){
...
function loadMainGrid(gridApi) {
	...
	$.ajax({
	  async: false,
	  url:'/admin-portal/control/getActivityType',
	  type:"POST",
...
var columnDefs = [
	{ 
     ...
     { 
        ...
        "sortable":true,
        "filter":"agTextColumnFilter",
        "cellRenderer":params => `<a href="viewActivityType?enumId=${params.data.enumId}">${params.value}</a>`},
