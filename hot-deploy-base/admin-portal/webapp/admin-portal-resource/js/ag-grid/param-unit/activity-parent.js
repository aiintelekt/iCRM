fagReady("PARAM_ACT_PRNT", function(el, api, colApi, gridApi){
...
function loadMainGrid(gridApi) {
	...
	$.ajax({
	  async: false,
	  url:'/admin-portal/control/getActivityParent',
	  type:"POST",
...
var columnDefs = [
	{ 
        ...
        "field":"activityParentDesc",
        "sortable":true,
        "filter":"agTextColumnFilter",
        "cellRenderer":params => `<a href="viewActivityParent?enumId=${params.data.enumId}">${params.value}</a>`
	},
