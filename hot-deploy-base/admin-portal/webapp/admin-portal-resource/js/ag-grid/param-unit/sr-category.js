...
//fagReady("PARAM_SR_AREA", function(el, api, colApi, gridApi){
...
//	$.ajax({
//	  async: false,
//	  url:'/admin-portal/control/getSrArea',
//	  type:"POST",
...
{ 
	...
	{ 
	   ...
	   "sortable":true,
	   "filter":true,
	   "cellRenderer":params => `<a href="viewServiceRequestArea?custRequestCategoryId=${params.data.code}">${params.value}</a>`
	},
...
$(function() {
	let paramSrAreaInstanceId= "PARAM_SR_AREA";
	let gridInstance  = "";
	var externalLoginKey = $('#externalLoginKey').val();
	var userId = $("#userId").val();

	const formDataObject = {};
	formDataObject.gridInstanceId = paramSrAreaInstanceId;
	formDataObject.externalLoginKey = externalLoginKey;
	formDataObject.userId = userId;	
	
	gridInstance = prepareGridInstance(formDataObject);
	
	$('#sr-category-save-pref-btn').click(function(){
		saveGridPreference(gridInstance, paramSrAreaInstanceId, userId);
	});
	$("#sr-category-list-export-btn").click(function() {
		gridInstance.exportDataAsCsv();
	});
	$('#sr-category-clear-filter-btn').click(function(){
		clearGridPreference(gridInstance, paramSrAreaInstanceId, userId);
		if (gridInstance) {
		    gridInstance.destroy();
		}
		gridInstance = prepareGridInstance(formDataObject);
		if(gridInstance){
			getParamSrAreaGridData();
		}
	});
	$('#sr-category-sub-filter-clear-btn').click(function(){
	...
	function getParamSrAreaGridData(){
		gridInstance.showLoadingOverlay();

		const callCtx = {};
		callCtx.ajaxUrl = "/admin-portal/control/getSrArea";
