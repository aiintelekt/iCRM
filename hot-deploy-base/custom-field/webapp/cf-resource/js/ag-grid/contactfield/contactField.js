...
var columnDefs = [{ 
	...
	{ 
	   ...
	   cellRenderer: function(params) {
		   if(params.data.customFieldLength == -1)
			   return 'Unlimited';
		   else
			   params.data.customFieldLength;
       },
	   //cellRenderer: params => `${params.data.customFieldLength} == -1 > `Unlimited` <#else> `${params.data.customFieldLength}` </#if>
	},
	{ 
	   "headerName":"Hide",
	   "field":"hide",
	...
	{ 
	   ...
	   cellRenderer: params => `<a href="editContactField?customFieldId=${params.data.customFieldId}&groupId=${params.data.groupId}" class="btn btn-xs btn-primary tooltips" data-original-title="Edit"><i class="fa fa-pencil info"></i></a>
		<a class="btn btn-xs btn-danger tooltips confirm-message" href="deleteContactField?customFieldId=${params.data.customFieldId}&groupId=${params.data.groupId}" data-original-title="Remove"><i class="fa fa-times red"></i></a>`
	}
];
