...
<div class="row">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="portlet-body form">
			<form id="mainFrom" role="form" class="form-horizontal" action="<@ofbizUrl>updateCustomField</@ofbizUrl>" encType="multipart/form-data" method="post" data-toggle="validator">
...
<div class="row padding-r" style="padding-top: 20px">
	...
	<div class="col-md-7 col-sm-7">
		<div id="main" role="main" style="width: 870px;">		
