 ...
 * 
 */
package org.groupfio.custom.field.constants;
...
public class CustomFieldConstants {
	...
	// Resource bundles	
    public static final String configResource = "custom-field";
    public static final String uiLabelMap = "CustomFieldUiLabels";
