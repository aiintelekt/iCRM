...
public class PartyHelper {
    ...
    public static String getFirstPartyRoleTypeId(String partyId, Delegator delegator) throws GenericEntityException {
    	String roleTypeId = "";
    	try {
    		if(UtilValidate.isNotEmpty(partyId)) {
    			GenericValue partyRole = EntityQuery.use(delegator).select("partyId","roleTypeId").from("PartyRole").where("partyId",partyId).queryFirst();
    			if(UtilValidate.isNotEmpty(partyRole) && UtilValidate.isNotEmpty(partyRole.getString("roleTypeId"))) {
