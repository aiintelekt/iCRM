...
<fo:block text-align="left">
    <fo:external-graphic src="${applicationInternalUrl!}/bootstrap/images/reeb-logo.jpg" overflow="hidden" height="40px" content-height="scale-to-fit" content-width="2.00in"/>
</fo:block>
