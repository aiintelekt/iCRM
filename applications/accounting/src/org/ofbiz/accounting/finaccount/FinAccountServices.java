...
public class FinAccountServices {
    ...
    public static Map<String, Object> createFinAccountForStore(DispatchContext dctx, Map<String, Object> context) {
        ...
        try {
            ...
            // now use our values
            String finAccountCode = getNewFinAccountCode(accountCodeLength.intValue(), delegator);
            ...
            if ("Y".equalsIgnoreCase(requirePinCode)) {
                String pinCode = getNewFinAccountCode(pinCodeLength.intValue(), delegator);
    ...
    public static Map<String, Object> checkFinAccountBalance(DispatchContext dctx, Map<String, Object> context) {
        ...
        if (finAccountId == null) {
            try {
                finAccount = getFinAccountFromCode(finAccountCode, delegator);
    ...
    public static Map<String, Object> checkFinAccountStatus(DispatchContext dctx, Map<String, Object> context) {
        ...
        if (finAccount != null) {
            ...
            if ("FNACT_ACTIVE".equals(statusId) && balance.compareTo(ZERO) < 1) {
            ...
            } else if ("FNACT_MANFROZEN".equals(statusId) && balance.compareTo(ZERO) > 0) {
        ...
        if (finAccount != null) {
            ...
            if (actualBalance.compareTo(BigDecimal.ZERO) > 0) {
                ...
                try {
                    ...
                    GenericValue trans;
                    while (remainingBalance.compareTo(ZERO) < 0 && (trans = eli.next()) != null) {
                ...
                if (remainingBalance.compareTo(ZERO) == 1) {
