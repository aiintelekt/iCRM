        ...
        try {
            ...
            if (finAccountSettings != null) {
                ...
                if ("Y".equals(finAccountSettings.getString("requirePinCode"))) {
                    if (!validatePin(delegator, finAccountCode, finAccountPin)) {
            ...
            if (availableBalance == null) {
                ...
                availableBalance = availableBalance.setScale(decimals, rounding);
