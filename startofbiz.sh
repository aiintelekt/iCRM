...
MEMIF="-Xms1024M -Xmx2048M -XX:MaxPermSize=3048M -Dmail.smtp.ssl.protocols=TLSv1.2 -Dhttps.protocols=TLSv1.2 -Ddeployment.security.TLSv1.2=true -Djdk.tls.client.protocols=TLSv1.2"
#MEMIF="-Xms8g -Xmx8g"
