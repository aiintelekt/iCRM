package org.groupfio.account.portal;

/**
 * @author Sharif Ul Islam
 *
 */
public class AccountPortalConstants {
	...
	public static final class AccountSearchType {
        private AccountSearchType() { }
        public static final String MY_TEAM_ACCOUNTS = "my-team-accounts";
        public static final String MY_ACTIVE_ACCOUNT = "my-active-account";
    }
}
