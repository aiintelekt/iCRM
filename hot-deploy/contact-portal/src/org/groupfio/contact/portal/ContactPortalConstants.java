package org.groupfio.contact.portal;

/**
 * @author Sharif Ul Islam
 *
 */
public class ContactPortalConstants {

	// Resource bundles	
    public static final String configResource = "contact-portal";
    public static final String uiLabelMap = "contact-portalUiLabels";
