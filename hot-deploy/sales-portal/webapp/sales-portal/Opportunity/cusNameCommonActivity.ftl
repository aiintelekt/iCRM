...
<div class="dropdown-menu" aria-labelledby="cust-icon"></a>
    ...
    />
    <a class="dropdown-item" href="/sales-portal/control/addTask?workEffortId=${requestParameters.workEffortId?if_exists}"><i class="fa fa-clipboard" aria-hidden="true"></i> Task</a>
    <a class="dropdown-item" href="/sales-portal/control/addPhoneCall?workEffortId=${requestParameters.workEffortId?if_exists}"><i class="fa fa-phone" aria-hidden="true"></i> Phone Call</a>
    <a class="dropdown-item" href="/sales-portal/control/addEmail?workEffortId=${requestParameters.workEffortId?if_exists}"><i class="fa fa-envelope" aria-hidden="true"></i> Email</a>
    <a class="dropdown-item" href="/sales-portal/control/addAppointment?workEffortId=${requestParameters.workEffortId?if_exists}"><i class="fa fa-calendar" aria-hidden="true"></i> Appointment</a>
    <a class="dropdown-item" href="/sales-portal/control/addOthers?workEffortId=${requestParameters.workEffortId?if_exists}"><i class="fa fa-square" aria-hidden="true"></i> Others</a>
</div>
<ul class="text-right">
