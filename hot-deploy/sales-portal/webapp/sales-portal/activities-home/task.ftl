...
<script type="text/javascript" src="/sales-portal-resource/js/ag-grid/addSalesActivity.js"></script>
    <div class="row">
        <div id="main" role="main">
            ...
            <@sectionFrameHeader   title="${uiLabelMap.addTask}"  extraLeft=extraLeft  />
            ...
            <form method="post" action="<#if (parameters.salesOpportunityId)?has_content>addSalesTaskEvent<#else>salesAddTaskEvent</#if>" id="SalesTask" class="form-horizontal" name="SalesTask" novalidate="novalidate" data-toggle="validator">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row p-2">
                        <div class="col-md-12 col-lg-6 col-sm-12">
                            ...
                            <@inputDate id="taskDate" name="taskDate" label="Date" type="customdatetime" placeholder="Date" value=today/>

                            <@inputRow id="subject" name="subject" label="Subject" placeholder=""/>
               		...
               		<div class="col-lg-12 col-lg-12 col-lg-12 ">
               			<@textareaLarge label="${uiLabelMap.Description}" id="messages" rows="3" />
            		</div>
