...
<div class="row">
	<div id="main" role="main">
  		<#--  ${screens.render("component://sales-portal/widget/opportunity/OpportunityScreens.xml#ActivityView")} -->
            ...
            <@sectionFrameHeader   title="${uiLabelMap.addOthers}"  extraLeft=extraLeft  />
            ...
            <form method="post" action="<#if (parameters.salesOpportunityId)?has_content>addSalesOthersEvent<#else>salesAddothersEvent</#if>" id="SalesOthers" class="form-horizontal" name="salesothers" novalidate="novalidate" data-toggle="validator">
