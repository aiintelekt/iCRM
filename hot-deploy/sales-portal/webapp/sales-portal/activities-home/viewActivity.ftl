<#include "component://admin-portal/webapp/admin-portal/global/ofbizFormMacros.ftl"/>
    ...
    <input type='hidden' id="businessUnitId" name="businessUnitId" value="${requestParameters.businessUnitId?if_exists}" />
          <div id="main" role="main">
                <div class="top-band bg-light">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="text-right position-absolute" style="right:20px;">
                            <#-- <a title="Assign" id="assign" href="#" class="btn btn-primary btn-xs mt-1" onclick=""><i class="fa fa-save" aria-hidden="true"></i>Assign</a>
                             ...
                             <a title="CLose Activity" href="#" id="doCancel" class="btn btn-primary btn-xs mt-1" ><i class="fa fa-window-close-o" aria-hidden="true"></i>Close Activity</a>
       					-->
	               ...
	               <button type="button" class="btn btn-primary btn-xs mt-1" id="doSave"><i class="fa fa-save" aria-hidden="true"></i>Save</button>
	                <button type="button" class="btn btn-primary btn-xs mt-1" id="doCancel"><i class="fa fa-save" aria-hidden="true"></i>CLose Activity</button>
       					</div>
                    </div>
                </div>
               </div>
               ...
               <div class="card-head margin-adj mt-2">          
            	  ${screens.render("component://sales-portal/widget/opportunity/OpportunityScreens.xml#cusNameCommonActivity")}
              </div
          ...
          <div class="card-head margin-adj mt-2" id="cp">
            ${screens.render("component://sales-portal/widget/opportunity/OpportunityScreens.xml#customerRowCommonActivity")} 
        </div>  
        <div class="col-lg-12 col-md-12 col-sm-12">       
            <form>
