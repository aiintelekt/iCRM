...
segmentationValues = delegator.findList("IcrmSegmentationStats", EntityCondition.makeCondition("roleTypeId", EntityOperator.EQUALS, "LEAD"), null, ["-timeComputed"], null, false);
