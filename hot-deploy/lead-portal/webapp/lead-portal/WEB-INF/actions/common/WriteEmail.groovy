...
templates = delegator.findList("TemplateMaster", new EntityConditionList(cond, EntityOperator.OR), null, UtilMisc.toList("templateName"), null, false);
...
userEmailAddresses = delegator.findByAnd("PartyAndContactMech", UtilMisc.toMap("contactMechTypeId", "EMAIL_ADDRESS", "partyId", userLogin.getString("partyId")), null, false);
...
if ("MKTG_CAMPAIGN".equals(parameters.get("emailType"))) {
    ...
    campaigns = delegator.findList("MarketingCampaign", conditions, null, UtilMisc.toList("campaignName"), null, false);
