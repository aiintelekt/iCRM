...
<div class="row">
	...
	<#--	<#assign extraLeft='
        ...
        <#assign edit = '${requestParameters.edit!}' >
        <#assign extraLeft='
      ...
      <#--   <@sectionFrameHeader  title="Recently Viewed:"  extraLeft=extraLeft  /> -->
        ...
        <!--<div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <!-- <div class="card-header mt-3" id="cp">
            ...
            <form id="mainFrom" method="post" action="<#if edit?has_content><@ofbizUrl>updateActivityEvent</@ofbizUrl><#else><@ofbizUrl>createTaskActivityAction</@ofbizUrl></#if>" data-toggle="validator" onsubmit="return submitActivityForm();">
            <div class="col-lg-12 col-md-12 col-sm-12"> 
	        	...
	        	<div>
	                ...
	                <@dynaScreen 
		                instanceId="CREATE_TASK_ACTIVITY_LEAD"
		                modeOfAction="CREATE"
		             />
	            </div>
