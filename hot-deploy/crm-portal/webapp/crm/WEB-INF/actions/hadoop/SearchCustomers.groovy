...
*/
println("conditionsList> "+conditionsList);
...
count = delegator.findCountByCondition("HdpCustomerSme", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpCustomerSme", mainConditons, UtilMisc.toSet("lcin"), null, efo, false);
...
entityList = delegator.findList("HdpCustomerSme", mainConditons, null, null, efo, false);
