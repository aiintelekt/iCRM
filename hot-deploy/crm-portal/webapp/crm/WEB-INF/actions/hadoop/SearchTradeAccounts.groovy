...
count = delegator.findCountByCondition("HdpTradeAccount", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpTradeAccount", mainConditons, UtilMisc.toSet("lcin"), null, efo, false);
...
entityList = delegator.findList("HdpTradeAccount", mainConditons, null, null, efo, false);
