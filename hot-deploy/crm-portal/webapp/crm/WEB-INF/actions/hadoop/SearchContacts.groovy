...
count = delegator.findCountByCondition("HdpContact", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpContact", mainConditons, UtilMisc.toSet("lcin"), UtilMisc.toList("-createdStamp"), efo, false);
...
entityList = delegator.findList("HdpContact", mainConditons, null, UtilMisc.toList("createdStamp"), efo, false);
