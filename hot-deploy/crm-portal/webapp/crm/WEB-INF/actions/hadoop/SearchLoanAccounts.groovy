...
count = delegator.findCountByCondition("HdpLoanAccount", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpLoanAccount", mainConditons, UtilMisc.toSet("lcin"), null, efo, false);
...
entityList = delegator.findList("HdpLoanAccount", mainConditons, null, null, efo, false);
