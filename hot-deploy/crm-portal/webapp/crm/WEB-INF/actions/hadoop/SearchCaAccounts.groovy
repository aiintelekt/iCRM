...
count = delegator.findCountByCondition("HdpCaAccount", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpCaAccount", mainConditons, UtilMisc.toSet("lcin"), UtilMisc.toList("-createdStamp"), efo, false);
...
entityList = delegator.findList("HdpCaAccount", mainConditons, null, UtilMisc.toList("createdStamp"), efo, false);
