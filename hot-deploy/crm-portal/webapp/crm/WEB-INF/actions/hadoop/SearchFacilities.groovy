...
count = delegator.findCountByCondition("HdpFacilities", mainConditons, null, UtilMisc.toSet("lcin"), efoNum);

/*
entityList = delegator.findList("HdpFacilities", mainConditons, UtilMisc.toSet("lcin"), null, efo, false);
...
entityList = delegator.findList("HdpFacilities", mainConditons, null, null, efo, false);
