...
<div class="page-header">
   <div class="float-right">
      <#-- <button type="button" class="btn btn-xs btn-primary m5" data-toggle="modal" data-target="#assignLeadModal" onClick="loadFindLeads()" >${uiLabelMap.assignLead}</button>  -->
      <a class="btn btn-xs btn-primary m5 li-modal" href="<@ofbizUrl>viewFindLeadsinContact</@ofbizUrl>">${uiLabelMap.assignLead}</a>
   </div>
   <h2 class="">${uiLabelMap.CommonLead}</h2>
</div>
      ...
      <div class="panel-heading" role="tab" id="heading_${i}" >
      	<div class="float-right position-absolute"  style="right: 0; padding-right: 65px; padding-top: 10px;">
               <form name="updateDefaultContact_${i}" id="updateDefaultContact_${i}" method="post" action="updateDefaultContact">
                  <input type="hidden" name="activeTab" value="lead" />
         ...
         <h4 class="panel-title">
            <a class="panel-collapse collapse show" role="button" data-parent="#" <#if requestURI == "viewContact"> href="<@ofbizUrl>viewLead?partyId=${leadContactsAssoc.leadId!}</@ofbizUrl>" </#if> aria-expanded="true" aria-controls="heading_${i}" style="">
            ${leadContactsAssoc.companyName!} (${leadContactsAssoc.leadId!})
            </a>
         </h4>
      </div>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4">
                     <div class="border rounded pl-2 pr-2">
                        <div class="page-header">
                           <div class="float-right">
                              <i class="fa fa-plus btn btn-xs btn-primary" aria-hidden="true" data-toggle="modal" data-target="#emailModal1" onclick=findEmail("emailtableid_${i}","${leadContactsAssoc.contactId!}","${leadContactsAssoc.leadId!}","${leadContactsAssoc.partyRelAssocId!}");></i>
                           </div>
                  ...
                  <div class="col-md-4 col-sm-4">
                     <div class="border rounded pl-2 pr-2">
                        <div class="page-header">
                           <div class="float-right">
                              <i class="fa fa-plus btn btn-xs btn-primary" aria-hidden="true" data-toggle="modal" data-target="#phoneModal1" onclick=findPhone("phonetableid_${i}","${leadContactsAssoc.contactId!}","${leadContactsAssoc.leadId!}","${leadContactsAssoc.partyRelAssocId!}");></i>
                           </div>
                           <h2 class="display-4">Phone Numbers</h2>
                        </div>
                        <div class="table-responsive">
                  ...
                  <div class="col-md-4 col-sm-4">
                     <div class="border rounded pl-2 pr-2">
                        <div class="page-header">
                           <div class="float-right">
                              <i class="fa fa-plus btn btn-xs btn-primary" aria-hidden="true" data-toggle="modal" data-target="#designationModal1" onclick=findDesignation("designationtableid_${i}","${leadContactsAssoc.contactId!}","${leadContactsAssoc.leadId!}","${leadContactsAssoc.partyRelAssocId!}");></i>
                           </div>
                           <h2 class="display-4">Designation</h2>
                        </div>
                        <div class="table-responsive">
...
<div id="emailModal1" class="modal fade" role="dialog">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="card-header">
               <div class="table-responsive">
                  <table id="ajaxEmailDatatable1" class="table table-striped">
                     <thead>
                        <tr>
                           <th>Email</th>
                           <th>Purpose</th>
...
<div id="phoneModal1" class="modal fade" role="dialog">
   <div class="modal-dialog modal-lg">
      <!-- Modal content-->
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body">
            <div class="card-header">
               <div class="table-responsive">
                  <table id="ajaxPhoneDatatable1" class="table table-striped">
                     <thead>
                        <tr>
                           <th>Phone Number</th>
                           <th>Purpose</th>
...
<div id="designationModal1" class="modal fade" role="dialog">
   <div class="modal-dialog modal-lg">
      <!-- Modal content-->
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body">
            <div class="card-header">
               <div class="table-responsive">
                  <table id="ajaxDesignationDatatable1" class="table table-striped">
                     <thead>
                        <tr>
                           <th>Positions</th>
                        </tr>
...
<form method="post" name="contactLeadForm" id="contactLeadForm">
   <input type="hidden" name="activeTab" value="lead" />
   <input type="hidden" name="donePage" id="donePage" value='${requestURI?if_exists}'/>
   <input type="hidden" name="leadPartyId" id="leadPartyId" value=""/>
   <input type="hidden" name="partyId" id="partyId" value="${leadPartyId?if_exists}"/>
   <input type="hidden" name="contactPartyId" id="contactPartyId" value="${leadPartyId?if_exists}"/>
</form>
<script>
   ...
   console.log("hg"+contactPartyId+"fdsf"+leadPartyId+"jghjg"+partyRelAssocId+"ghfg");
       $("#ajaxEmailDatatable1").DataTable({
           "processing": true,
           "destroy": true,
           "async":false,
           "ajax": {
   ...
   function findDesignation(id, contactPartyId, leadPartyId, partyRelAssocId) {
       $("#ajaxDesignationDatatable1").DataTable({
           "processing": true,
           "destroy": true,
           "ajax": {
               "url": "getContactsLeadDetails",
...
<script>
function assignContactToLead(partyId){
       $('#leadPartyId').val(partyId);
       $("#contactLeadForm").attr("action", "assignContactToLead");
       $('#contactLeadForm').submit();
}
