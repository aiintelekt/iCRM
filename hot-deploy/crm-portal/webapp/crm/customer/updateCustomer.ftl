...
<div class="row">
    <div id="main" role="main">
        <@sectionFrameHeader title="${uiLabelMap.UpdateCustomer}" />
        <div class="col-md-12 col-lg-12 col-sm-12 ">
            <form method="post" action="updateCustomerService" id="updateCustomerForm" class="form-horizontal" name="updateCustomerForm" novalidate="novalidate" data-toggle="validator">
