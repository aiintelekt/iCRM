<div class="small-box border rounded">
	<div class="inner float-left mr-4">
		<h4>Tasks Created/Completed by Day</h4>
	...
	<div  id="task_by_day_chart" style="width: 100%; height: 300px;display: inline-block;"></div> 
</div>
...
$("#tbd_timePeriod").change(function() {
	loadTaskByDayChart();
});

});

function loadTaskByDayChart() {

	var dom = document.getElementById("task_by_day_chart");
	var myChart = echarts.init(dom);
	var app = {};
	$.ajax({
		async : false,
		url : '/activity-portal/control/getTaskByDayChartData',
		type : "POST",
		data : {
		...
		success : function(data) {
			...
			var chartData = data.task_by_day_chart_data;
			
			var xAxisData = data.xAxisData;
			var openActivityData = chartData.openActivityData;
