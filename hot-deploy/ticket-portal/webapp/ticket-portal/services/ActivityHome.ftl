    	...
    	<form action="Activities" method="post" id="Activities" name="Activities">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
    			<div class="page-header border-b pt-2">
                	...
                	<a id="csr_icon" title="Add Activities" href="<@ofbizUrl>srAddTask</@ofbizUrl>" class="text-dark ">
					...
					<a id="export_to_excel_icon" title="Search" href="<@ofbizUrl>findSrActivity</@ofbizUrl>" class="btn btn-primary btn-xs">
