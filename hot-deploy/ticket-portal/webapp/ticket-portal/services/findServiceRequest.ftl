                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingTwo">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#accordionDynaBase" aria-expanded="false" aria-controls="collapseOne"> ${uiLabelMap.MainFilter}
                            </a>
                        </h4>
                    </div>
                    <div id="accordionDynaBase" class="panel-collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <form method="post" id="searchForm" class="form-horizontal" novalidate="novalidate" data-toggle="validator">
                                <div class="margin-adj-accordian pad-top">
                                    <div class="row p-2">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input type="hidden" name="searchType" value="SR">
                                            <#-- <input type="hidden" name="isFilterByEarliestDueDate" value="Y"> -->
                                            <input type="hidden" name="locationCustomFieldId" value="${locationCustomFieldId!}">
                                            ...
                                            <@dynaScreen 
                                                <!--instanceId="FIND_SERVICE_REQUEST" -->
                                                instanceId="FIND_SR_GEN"
                                                modeOfAction="CREATE"
                                                />
                                        </div>
                                    </div>
                                            ...
                                            <div class="text-right pd-cbx-lbls" style="padding-top: 0px;">
                                                <div class="form-check-inline">
                                                    <label class="form-check-label flx-cbx-lbl">
                                                        <input id="hold" name="hold" class="form-check-input" value="" type="checkbox">Hold
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label flx-cbx-lbl">
                                                ...
                                                <@button id="sr-search-btn" label="${uiLabelMap.Find}" />
...
<script>
	...
	$(document).ready(function() {
		...
		loadCategory();
		CMMUTIL.loadOwners('SR_OWNER', null, null, "Y", "${requestAttributes.externalLoginKey!}");
	});
...
function getPrimaryContacts(partyId){
 ...
 <#-- function process(date) {
	...
	$("#srType").change(function() {
		console.log('sr type change');
		$("#srArea").dropdown('clear');
	...
	$(".srSubArea-input").one("click", function() {
		var srCategoryId = $("#srArea").val();
		loadSubCategory(srCategoryId);
	});
