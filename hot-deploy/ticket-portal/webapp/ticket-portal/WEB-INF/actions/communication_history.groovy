...
if(UtilValidate.isNotEmpty(custRequestId)) {
	...
	isAltSrActive.getString("isActive").equalsIgnoreCase("Y") &&UtilValidate.isNotEmpty(isAltSrActive.getString("parameterId"))) {
		String altSR=org.fio.homeapps.util.DataUtil.getCustRequestAttrValue(delegator,isAltSrActive.getString("parameterId"),custRequestId);
...
if(UtilValidate.isNotEmpty(custRequestId)){
	...
	if(UtilValidate.isNotEmpty(custRequestWorkEffortList)){
		...
		if(UtilValidate.isNotEmpty(custRequestWorkEffortIds)){
			...
			emailWorkEffortConditionList.add(EntityCondition.makeCondition("workEffortTypeId",EntityOperator.EQUALS,"EMAIL"));
	...
	String emailSubject="Updated SR ID - "+"["+custRequestId+"]";
	if (UtilValidate.isNotEmpty(CustRequest) && UtilValidate.isNotEmpty(CustRequest.get("custRequestName"))){
		emailSubject = emailSubject+" - "+CustRequest.get("custRequestName");
	}
