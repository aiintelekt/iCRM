...
<div class="page-header border-b pt-2" syle="margin-bottom: -15px;">
	...
	<ul class="flot-icone">
		...
		<li class="mt-0">
			<a href="<@ofbizUrl>updateCustomer?partyId=</@ofbizUrl>${inputContext.partyId!}" title="Update" style="" class="btn btn-xs btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> </a>
		</li>
