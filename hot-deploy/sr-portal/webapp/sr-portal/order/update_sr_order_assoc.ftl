...
$("#actualQty").html('${inputContext.totalActualQty!}');
$("#appliedQty").html('${inputContext.totalAppliedQty!}');
$("#availableQty").html('${inputContext.totalAvailQty!}');
...
$("#sync-order-assoc").click(function() {
	$.ajax({
        ...
        data: {"orderId": $("#mainFrom input[name=orderId]").val(), "orderDate": $("#mainFrom input[name=orderDate]").val(), "location": $("#locationId").val(), "externalId": $("#mainFrom input[id=orderId_alter]").val(), "srNumber": $("#mainFrom input[name='srNumber']").val(), "externalLoginKey": "${requestAttributes.externalLoginKey!}"},
        async: false,
