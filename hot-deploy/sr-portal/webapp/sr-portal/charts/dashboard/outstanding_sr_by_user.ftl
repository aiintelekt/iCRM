           ...
           <div class="inner float-left mr-4">
                <h4>Outstanding FSRs by User</h4>
           ...
           <div class="clearfix"></div>
			<div  id="container-2" style="width: 100%; height: 500px;display: inline-block;"></div> 
   	  </div>
...
function loadSrByUser(segVal) {
		...
		$.ajax({
		  async: false,
		  url:'/sr-portal/control/getSrByUserChartData',
		  type:"POST",
		  ...
		  success: function(data){	
				...
				$('#container-2').prepend('<img id="noDataImg" src="/bootstrap/images/nodata-found.jpg" class="nodata-img" />');
