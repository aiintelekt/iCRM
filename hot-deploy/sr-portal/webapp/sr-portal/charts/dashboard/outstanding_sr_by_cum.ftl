   <div class="small-box border rounded">
          <div class="inner float-left mr-4">
            <h4>FSRs Created/Closed/Outstanding</h4>
            <div class="dropdown">
	...
	<div class="chart" id="container-4" style="width: 100%; height: 500px;display: inline-block;"></div>  
  </div>
...
function loadLineChart(segVal) {
		...
		$.ajax({
		  async: false,
		  url:'/sr-portal/control/getSrCumLineChartData',
		  type:"POST",
		  ...
		  success: function(data){	
					...
					$('#container-4').prepend('<img id="noDataImg" src="/bootstrap/images/nodata-found.jpg" class="nodata-img" />');
