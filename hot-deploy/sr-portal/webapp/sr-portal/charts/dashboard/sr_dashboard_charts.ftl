...
<#assign presentDate = "${presentDate?if_exists}">     
	...
	<@sectionFrameHeader title="FSR Dashboard" />
         <div class="row">
            
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
               ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByuserChart")}
			  </div>

              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
               ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByTypeChart")}
               </div>
             

              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByCateChart")}
			  </div>
              

              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
               ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByDayChart")}
              </div>
             

              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
               ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByCumChart")}
              </div>
              
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
               ${screens.render("component://sr-portal/widget/dashboard/DashboardScreens.xml#srByEowChart")}
              </div>
