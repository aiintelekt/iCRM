                		...
                		<form action="#" method="post" id="Activities" name="Activities">
              				...
              				<div class="row p-2">
	                    		...
	                    		<div class="col-lg-4 col-md-6 col-sm-12">
	                            	...
	                            	/>
	                    			<#assign  statusList = (Static["org.ofbiz.entity.util.EntityQuery"].use(delegator).from("StatusItem").where("statusTypeId", "IA_STATUS_ID", "isEnabled", "Y").queryList())?if_exists>
