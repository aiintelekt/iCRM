    ...
    <div id="main" role="main">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 dash-panel">
            ...
            ' />  
             ...
             <#assign rightContent='<span id="mark-complete-btn" class="btn btn-primary btn-xs ml-2" data-toggle="confirmation" title="Are you sure you want to close this Activity?" aria-expanded="false"> <i class="fa fa-save" aria-hidden="true"></i> Mark Complete </span>
            ' />
           ...
           <#-- <@AgGrid
	            ...
	            debug="false"
	            />    
            <script type="text/javascript" src="/sr-portal-resource/js/ag-grid/activity/find-activity.js"></script>-->
    <input type="hidden" id="userId" value="${userLogin.userLoginId!}"/>
  	<input type="hidden" id="externalLoginKey" value="${requestAttributes.externalLoginKey!}"/>
		...
		<@fioGrid 
			...
			instanceId="ACTIVITY_LIST"
			jsLoc="/sr-portal-resource/js/ag-grid/activity/find-activity.js"
			headerLabel="List of Activities"
			...
			exportBtnId="activity-list-export-btn"
			/>
        </div>
    </div>
</div>
